...
INITIALIZE_PASS(Flattening,"cffobf", "Enable Control Flow Flattening.", true,true)
...
bool Flattening::flatten(Function *f) {
    ...
    for (Function::iterator i = f->begin(); i != f->end(); ++i) {
        ...
        if (tmp->isEHPad() || tmp->isLandingPad()) {
            errs() << f->getName()
                   << " Contains Exception Handing Instructions and is unsupported for flattening in the open-source version of Hikari.\n";
            return false;
        }
