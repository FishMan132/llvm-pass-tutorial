...
static cl::opt<int> SplitNum("split_num", cl::init(2), cl::desc("Split <split_num> time each BB"));
...
// 源码分析 https://bbs.pediy.com/thread-255078.htm
...
bool SplitBasicBlock::containsPHI(BasicBlock *b) {
    for (BasicBlock::iterator I = b->begin(), IE = b->end(); I != IE; ++I) {
        // PHINode https://www.cnblogs.com/ilocker/p/4897325.html
        if (isa<PHINode>(I)) {
            return true;
        }
    }
